...
"use client"; // SOLUÇÃO: Marcamos este componente como um "Client Component".
...
export function ProjectIdeator() {
  ...
  const [status, setStatus] = useState<
    "idle" | "loading" | "success" | "error" | "contact"
  >("idle");
  ...
  const renderContent = () => {
    switch (status) {
      case "loading":
        return (
          <div className="text-center p-8">
            ...
            <p className="mt-4 text-texto-claro">
              Nossa IA está elaborando seu projeto... Isso pode levar alguns
              segundos.
            </p>
          </div>
        );
      case "success":
        return (
          <div className="text-center p-8">
            ...
            <h3 className="mt-4 text-2xl font-bold text-texto">
              Contato Enviado!
            </h3>
            <p className="mt-2 text-texto-claro">
              Recebemos seu esboço de projeto. Entraremos em contato em breve
      ...
      case "contact":
        return (
          <div>
            <h3 className="text-2xl font-bold text-texto mb-4">
              Esboço do seu Projeto:
            </h3>
            <div className="bg-gray-100 p-4 rounded-lg mb-6 whitespace-pre-wrap font-mono text-sm text-texto-claro">
              {draft}
            </div>
            <h3 className="text-2xl font-bold text-texto mb-4">
              Gostou? Fale conosco!
            </h3>
            <p className="text-texto-claro mb-6">
              Preencha seus dados para que nossa equipe possa analisar seu
              projeto e entrar em contato.
            </p>
            <form onSubmit={handleContactSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-secundaria text-white font-bold py-3 px-6 rounded-lg hover:bg-orange-600 transition-colors flex items-center justify-center"
              >
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-texto">
            Tem uma Ideia? Nós a Estruturamos.
          </h2>
          <p className="text-lg text-texto-claro mt-2 max-w-3xl mx-auto">
            Descreva sua necessidade ou a ideia do seu próximo grande projeto.
            Nossa IA assistente criará um esboço inicial para você em segundos.
          </p>
        </div>
